...
<div class="chatbox">
    <div class="chatbox__support" style="visibility:hidden;" >
        ...
        <div class="chatbox__footer">
            <input type="text" placeholder="Write a message..." id="msg" onkeyup="handleEnter()" >
            <button class="chatbox__send--footer send__button" onclick="sendMessage()">Send</button>
        </div>
    </div>
    <div class="chatbox__button">
    <button onclick="toggleChatbox()"><img src="assets/images/chatbot/chatbox-icon.svg" /></button>
    </div>
</div>
<!--Script-->
...
<script>
    ...
    var messages = [];
    function sendMessage() {
    var textField =  $('.chatbox__footer input').val();
    let text1 = textField;
    if (text1 === "") {
